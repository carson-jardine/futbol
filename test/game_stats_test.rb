...
###############################
  def test_game_stats_has_games
    game_stats = GameStats.new("./data/games.csv")
    assert_equal 7, game_stats.games.count
  end
  def test_it_can_find_game_by_id
    game_stats = GameStats.new("./data/games.csv")
  ...
  def test_it_can_give_average_goals_per_season
    game_stats = GameStats.new("./data/games.csv")
    assert_equal ({"20122013"=>4.12, "20162017"=>4.23, "20142015"=>4.14, "20152016"=>4.16, "20132014"=>4.19, "20172018"=>4.44}), game_stats.average_goals_by_season
  end
end
