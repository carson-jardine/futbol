...
class SeasonStats
  ...
  def find_win_games_with_key_as_game_id(win_games)
    win_games.group_by do |game_won|
      game_won.game_id
    end
  end
  ...
  def find_win_games_this_season(this_season, win_games_with_key_as_game_id)
...
# Name of the Coach with the best win percentage for the season
  def winningest_coach(the_season)
    ...
    win_games_with_key_as_game_id = find_win_games_with_key_as_game_id(win_games)
    ...
    win_games_this_season = find_win_games_this_season(this_season, win_games_with_key_as_game_id)
